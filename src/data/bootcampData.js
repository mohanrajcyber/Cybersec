...
export const SESSION_CLASS_PATH = [
  ...
  { step: 4, day: 1, label: 'OSINT Info', path: '/info', icon: '🔍' },
  { step: 5, day: 2, label: 'UPI Scam Sim', path: '/lab/scam-sim', icon: '📱' },
  { step: 6, day: 2, label: 'SOC Logs', path: '/soc', icon: '📊' },
  { step: 7, day: 2, label: 'Breach Sim', path: '/lab/breach', icon: '💥' },
  { step: 8, day: 2, label: 'Recon Lab', path: '/recon', icon: '🕵️' },
  { step: 9, day: 3, label: 'Footprint', path: '/lab/footprint', icon: '👣' },
  { step: 10, day: 3, label: 'Mini CTF', path: '/ctf', icon: '🏆' },
]
